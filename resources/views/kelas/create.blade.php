<x-app-layout>
    <x-slot name="header">
        ...
        <div class="hidden md:flex md:items-center">
            ...
            <div>
                <h2 class="font-bold text-2xl text-gray-800 leading-tight">Tambah Kelas</h2>
                <p class="text-sm text-gray-600 mt-1">Tambahkan kelas baru ke sistem</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                <div class="bg-gradient-to-r from-indigo-500 to-purple-600 px-6 py-4">
                    <h3 class="text-lg font-semibold text-white">Form Tambah Kelas</h3>
                </div>
                <div class="p-8">
                    <form method="POST" action="{{ route('kelas.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="kelas" type="text" name="kelas" value="{{ old('kelas') }}" required autofocus
                            ...
                            <div class="relative">
                                ...
                                <select id="username" name="username"
                                    ...
                                    @foreach ($walikelas as $wali)
                                        <option value="{{ $wali->username }}" {{ old('username') == $wali->username ? 'selected' : '' }}>
