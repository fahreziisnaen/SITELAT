                    ...
                    <form method="POST" action="{{ route('murid.update', $murid->NIS) }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="NIS" type="text" name="NIS" value="{{ old('NIS', $murid->NIS) }}" required autofocus
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="nama_lengkap" type="text" name="nama_lengkap" value="{{ old('nama_lengkap', $murid->nama_lengkap) }}" required
                                    class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition duration-200">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <label class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all duration-200 hover:border-indigo-500 {{ old('gender', $murid->gender) == 'Laki-laki' ? 'border-blue-500 bg-blue-50' : 'border-gray-300' }}">
                                    <input type="radio" name="gender" value="Laki-laki" {{ old('gender', $murid->gender) == 'Laki-laki' ? 'checked' : '' }} required class="sr-only">
                                    <div class="flex items-center">
                                ...
                                <label class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all duration-200 hover:border-indigo-500 {{ old('gender', $murid->gender) == 'Perempuan' ? 'border-pink-500 bg-pink-50' : 'border-gray-300' }}">
                                    <input type="radio" name="gender" value="Perempuan" {{ old('gender', $murid->gender) == 'Perempuan' ? 'checked' : '' }} required class="sr-only">
                                    <div class="flex items-center">
                            ...
                            <div class="relative">
                                ...
                                <select id="kelas" name="kelas" required
                                    ...
                                    @foreach ($kelas as $kls)
                                        <option value="{{ $kls->kelas }}" {{ old('kelas', $murid->kelas) == $kls->kelas ? 'selected' : '' }}>
                                            {{ $kls->kelas }}
                                        </option>
                                    @endforeach
                                </select>
