<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Welcome Card -->
            <div class="bg-gradient-to-r from-indigo-500 to-purple-500 rounded-2xl shadow-xl p-4 sm:p-8 mb-8 text-white">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 {{ Auth::user()->role === 'Walikelas' ? 'lg:grid-cols-4' : 'lg:grid-cols-5' }} gap-4 sm:gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500 hover:shadow-xl transition-shadow duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800">{{ $stats['total_kelas'] ?? 0 }}</p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-yellow-500 hover:shadow-xl transition-shadow duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-600 mb-1">Total Murid</p>
                            <p class="text-3xl font-bold text-gray-800">{{ $stats['total_murid'] ?? 0 }}</p>
                        </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    <a href="{{ route('keterlambatan.create') }}" class="flex items-center p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg hover:from-blue-100 hover:to-blue-200 transition-all duration-300 group">
                        ...
                        <div>
                            <p class="font-semibold text-gray-800">Tambah Keterlambatan</p>
                            <p class="text-sm text-gray-600">Input data baru</p>
                        </div>
                    </a>

                    <a href="{{ route('report.index') }}" class="flex items-center p-4 bg-gradient-to-r from-green-50 to-green-100 rounded-lg hover:from-green-100 hover:to-green-200 transition-all duration-300 group">
                        <div class="bg-green-500 rounded-lg p-3 mr-4 group-hover:scale-110 transition-transform duration-300">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                        </div>
                        <div>
                            <p class="font-semibold text-gray-800">Lihat Report</p>
                            <p class="text-sm text-gray-600">Rekap keterlambatan</p>
                        </div>
                    </a>

                    <a href="{{ route('murid.index') }}" class="flex items-center p-4 bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg hover:from-purple-100 hover:to-purple-200 transition-all duration-300 group">
                        <div class="bg-purple-500 rounded-lg p-3 mr-4 group-hover:scale-110 transition-transform duration-300">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                            </svg>
                        </div>
                        <div>
                            <p class="font-semibold text-gray-800">Data Murid</p>
            ...
            <div class="bg-white rounded-xl shadow-lg p-4 sm:p-6">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($stats['recent_keterlambatan'] ?? [] as $item)
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ $item->nama_murid ?? '-' }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $item->kelas ?? '-' }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $item->waktu->format('H:i') }}</td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-4 text-center text-gray-500">Belum ada data keterlambatan</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                ...
                <div class="mt-4 text-center">
                    <a href="{{ route('keterlambatan.index') }}" class="text-indigo-600 hover:text-indigo-800 font-medium text-sm">
